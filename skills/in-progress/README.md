...
- **[c4-diagrams](./c4-diagrams/SKILL.md)**: Create, review, or refine C4 model software architecture diagrams. Model-invoked.
- **[extract-video-slides](./extract-video-slides/SKILL.md)**: Compile presentation videos into grounded subject skills with `yt-sl`. Model-invoked.
